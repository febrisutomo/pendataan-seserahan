                    ...
                    taskSnapshot.getStorage().getDownloadUrl()
                            .addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    db.child("Customer").child(getKey)
                                            .setValue(new Customer(nama, jk, alamat, noHp, uri.toString().trim()))
                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                @Override
                                                public void onSuccess(Void unused) {
                                                    progress.dismiss();
                                                    Toast.makeText(EditCustomerActivity.this, "Data berhasil diupdate!", Toast.LENGTH_SHORT).show();
                                                    finish();
                                                }
                                                ...
                                                public void onFailure(@NonNull Exception e) {
                                                    progress.dismiss();
                                                    Toast.makeText(EditCustomerActivity.this, "Data gagal diupdate!", Toast.LENGTH_SHORT).show();
                                                }
                                            });
                                }
                            });
