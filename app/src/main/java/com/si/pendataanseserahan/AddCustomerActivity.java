                                    ...
                                    db.child("Customer").push()
                                            ...
                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                ...
                                                public void onSuccess(Void unused) {
                                                    progress.dismiss();
                                                    Toast.makeText(AddCustomerActivity.this, "Data berhasil ditambahkan!", Toast.LENGTH_LONG).show();
                                                    finish();
                                                }
                                            }).addOnFailureListener(new OnFailureListener() {
                                                @Override
                                                public void onFailure(@NonNull Exception e) {
                                                    Toast.makeText(AddCustomerActivity.this, "Data gagal ditambahkan!", Toast.LENGTH_LONG).show();
                                                    progress.dismiss();
                                                }
                                            });
